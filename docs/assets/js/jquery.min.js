...
!(function(e, t) {
								...
								return (
									...
									(!d.sortDetached && t.compareDocumentPosition(e) === n)
										? e === C || (e.ownerDocument === m && y(m, e))
											? -1
											: t === C || (t.ownerDocument === m && y(m, t)) ? 1 : u ? P(u, e) - P(u, t) : 0
										: 4 & n ? -1 : 1)
								);
							}
						: function(e, t) {
	...
	k.fn.extend({
		...
		index   : function(e) {
			return e
				? 'string' == typeof e ? i.call(k(e), this[0]) : i.call(this, e.jquery ? e[0] : e)
	...
	(y.cors = !!Xt && 'withCredentials' in Xt),
		...
		k.ajaxTransport('script', function(n) {
			...
			if (n.crossDomain || n.scriptAttrs)
				return {
					send  : function(e, t) {
						(r = k('<script>').attr(n.scriptAttrs || {}).prop({ charset: n.scriptCharset, src: n.url }).on(
							'load error',
							(i = function(e) {
