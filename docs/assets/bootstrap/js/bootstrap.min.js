				...
				computeStyle    : {
					...
					fn              : function(t, e) {
						...
						if (
							((O =
								'bottom' === S
									? 'HTML' === b.nodeName ? -b.clientHeight + T.bottom : -w.height + T.bottom
									: T.top),
							(A =
								'right' === D
									? 'HTML' === b.nodeName ? -b.clientWidth + T.right : -w.width + T.right
									: T.left),
							E && I)
						)
				...
				(t._getPlacement = function() {
					...
					return (
						t.hasClass(ke)
							...
							: t.hasClass(Le)
								? (e = Qe)
								: t.hasClass(xe) ? (e = Ve) : p(this._menu).hasClass(Pe) && (e = Ke),
						e
					);
				}),
				...
				(i._jQueryInterface = function(n) {
					return this.each(function() {
						var t = p(this),
							e = t.data(Bi);
						if (
							(e || ((e = new i(this, 'object' == typeof n && n)), t.data(Bi, e)), 'string' == typeof n)
						) {
							if ('undefined' == typeof e[n]) throw new TypeError('No method named "' + n + '"');
							e[n](this);
						}
